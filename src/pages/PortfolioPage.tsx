            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              ...
              {portfolioImages.length > 0 && (
                <div className="flex items-center gap-3">
                  <span className="text-sm font-normal text-gray-500">Grid</span>
            ...
            >
              <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#2c5b53]/10">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="3" y="3" width="18" height="18" rx="3" stroke="#2c5b53" strokeWidth="1.5"/>
                  <circle cx="8.5" cy="8.5" r="1.5" fill="#2c5b53"/>
                  <path d="M21 15L16 10L5 21" stroke="#2c5b53" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <p className="text-base font-normal text-gray-500">Portfolio images coming soon</p>
            </motion.div>
          ) : (
            <motion.div
              initial={{ opacity: 0 }}
